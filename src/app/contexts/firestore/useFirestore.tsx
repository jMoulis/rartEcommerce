...
export const onFindAllRealtime = (
...
export const findAllOnce = async (collection: ENUM_COLLECTIONS) => {
  try {
...
export const onFetchDocsByIdsArray = async (
...
export const onFetchDocsByIdsArrayWithSnapshot = (
  documentRefIds: string[],
  collection: ENUM_COLLECTIONS,
...
export const onFindSingleRealtime = (
  collectionName: ENUM_COLLECTIONS,
  docId: string,
  onResult: (data: any) => void,
